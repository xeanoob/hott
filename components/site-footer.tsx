        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="flex flex-col gap-5">
              <h4 className="font-sans text-[0.6rem] font-semibold uppercase tracking-[0.35em] text-[#c5a880] mb-2">Découvrir</h4>
              <Link href="#technologie" className="font-sans text-sm text-black/40 transition-all hover:text-black hover:translate-x-1">Technologie</Link>
            ...
            <div className="flex flex-col gap-5">
              ...
              <Link href="#" className="font-sans text-sm text-black/40 transition-all hover:text-black hover:translate-x-1">Nous contacter</Link>
            ...
            <div className="flex flex-col gap-5">
              ...
              <Link href="#" className="font-sans text-sm text-black/40 transition-all hover:text-black hover:translate-x-1">Mentions légales</Link>
              <Link href="#" className="font-sans text-sm text-black/40 transition-all hover:text-black hover:translate-x-1">Confidentialité</Link>
              <Link href="#" className="font-sans text-sm text-black/40 transition-all hover:text-black hover:translate-x-1">CGV</Link>
            </div>
          </div>
        </div>

        {/* Bottom Section */}
        <div className="mt-24 pt-8 flex flex-col md:flex-row items-center justify-between border-t border-black/5 gap-6">
          <p className="font-sans text-[0.6rem] font-medium tracking-wide text-black/25">
            &copy; {new Date().getFullYear()} HOTT. TOUS DROITS RÉSERVÉS.
          </p>
          <div className="flex gap-8">
            <a href="#" className="font-sans text-[0.6rem] font-semibold uppercase tracking-widest text-black/40 transition-colors hover:text-black">Instagram</a>
            <a href="#" className="font-sans text-[0.6rem] font-semibold uppercase tracking-widest text-black/40 transition-colors hover:text-black">Facebook</a>
