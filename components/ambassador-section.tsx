    ...
    <section className="bg-white text-black border-t border-black/10">
      <div className="grid min-h-[80vh] grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-8 py-24 md:px-24">
          <span className="mb-4 block font-sans text-xs font-semibold uppercase tracking-widest text-[#c5a880]">
            Ambassadeur HOTT
          </span>
          <h2 className="font-sans text-4xl font-semibold leading-[1.1] tracking-tighter md:text-5xl lg:text-6xl text-black">
            L'excellence n'est pas une option.
          </h2>
          <p className="mt-8 max-w-md font-sans text-lg font-medium leading-relaxed text-black/60">
          ...
          <div className="mt-12">
            <a
              href="#"
              className="inline-block border border-black bg-black px-10 py-4 font-sans text-[0.65rem] font-medium uppercase tracking-[0.25em] text-white transition-colors duration-300 hover:bg-transparent hover:text-black"
            >
              Découvrir
            </a>
          </div>
